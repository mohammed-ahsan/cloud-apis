...
const {
  ...
  findProductBySubParentName,
} = require("../controller/productController");
const { findSubCategoriesByParentName } = require("../controller/categoryController");
...
router.get('/subcategoriesproduct/parent/:id', findProductBySubParentName);
