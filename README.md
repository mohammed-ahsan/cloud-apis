...
Gigapixel Server Documentation


Introduction: 

This is ready api backend for Gigapixel admin and frontend built with node.js, express, mongoose, and mongodb for database. 
...
For getting started with the template you have to follow the below procedure. First navigate to the Gigapixel-server directory.
...
We use heroku for hosting this server if you want to hosting on heroku just follow their documentation, You can also hosting this any other hosting services.# cloud-apis
