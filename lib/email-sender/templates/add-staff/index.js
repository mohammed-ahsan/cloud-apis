...
>
                                      ...
                                      <tr>
                                        <td style='width:150px;'>
                                          ...
                                          <img
                                            alt
                                            height='auto'
                                            src='https://res.cloudinary.com/ahossain/image/upload/v1676296566/Gigapixel%20files/cc_v8jite.png'
 ...
 <h2>Hello ${option.name}</h2>
    <p>A request has been received to add you as ${option.role === "Admin" ? "an" : "a"
     ...
     <p style="margin:0px auto; margin-top:40px; text-align:center;">Thank you   <h4 style="margin:1px; margin-bottom:0px; text-align:center;">Gigapixel Team</p></p>
